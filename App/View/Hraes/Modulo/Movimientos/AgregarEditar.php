                    ...
                    <div class="container">
                        ...
                        <div class="row mx-1">
                            <div class="col-4">
                                ...
                                <select class="form-control div-spacing custom-select" id="movimiento_general" required>
                                </select>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <label class="text-required">*</label>
                                <select class="form-control div-spacing custom-select" id="id_tbl_movimientos" required>
                                </select>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="custom-select-wrapper">
                                    <select class="form-control" aria-label="Default select example"
                                        id="id_cat_caracter_nombramiento" required>
                                    </select>
                                </div>
                            </div>
                        </div>
