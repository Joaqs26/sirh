            ...
            <div class="modal-header background-modal">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h1 class="text-tittle-card"><label id="titulo_asistencia"></label> incidencia.</h1>
                            <p class="color-text-white">En esta sección, puedes agregar y actualizar la información sobre las incidencias de los empleados. Aquí se gestionan todos los detalles relevantes y se mantienen actualizados.</p>
                        </div>
                    </div>
                </div>
            </div>
