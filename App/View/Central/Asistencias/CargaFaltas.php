  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header background-modal">
        <div class="container">
          <div class="row">
            ...
            <div class="col-10">
              <h1 style="color:white; font-family: 'Montserrat';font-size: 40px;">Justificación de faltas</h1>
              <p style="color:white;">Sección para justificar faltas y retrasos de forma masiva. Aquí
          ...
          <div class="container mt-4">
            <div class="instructions">
              ...
              <div class="alert alert-warning" role="alert">
                ...
                <a download href="../../../../assets/Formato/LAYOUT_JUSTIFICACION.xlsx">descárgalo aquí</a>.<br>

                <!-- 🔽 NUEVO ENLACE: INCIDENCIAS NO CARGADAS -->
                2. Al finalizar el proceso, puedes descargar el reporte de
                <a id="link-incidencias-no-cargadas"
                   download
                   href="../../../../App/Controllers/Central/FaltaC/Descargajust.php">
                                      incidencias no cargadas
                </a>.
                <br>
      ...
      <div class="modal-footer">
        <button onclick="ocultarModalFaltas();" type="button" class="btn btn-secondary" data-dismiss="modal">
          <i class="fas fa-times"></i> Cancelar
        </button>
        <button type="submit" onclick="return validarCargaFalta();" class="btn btn-success save-botton-modal">
