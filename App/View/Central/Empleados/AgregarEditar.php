        ...
        <div class="modal-content">
            <div class="modal-header background-modal">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h1 class="text-tittle-card"><label id="titulo"></label> empleado.</h1>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row mx-1">
                        <div class="col-4">
                            <label for="campo" class="form-label input-text-form">Nombre</label><label class="text-required">*</label>
                        ...
                        <div class="col-4">
                            <label for="campo" class="form-label input-text-form">Apellido paterno</label><label class="text-required">*</label>
                        ...
                        <div class="col-4">
                            <label for="campo" class="form-label input-text-form">Apellido materno</label><label class="text-required">*</label>
                    ...
                    <div class="row mx-1">
                        <div class="col-4">
                            <label for="campo" class="form-label input-text-form">Rfc</label><label class="text-required">*</label>
                        ...
                        <div class="col-4">
                            <label for="campo" class="form-label input-text-form">CURP</label><label class="text-required">*</label>
                            <input onkeyup="obtenerGenero(); obtenerEntidad();" maxlength="18" type="text"
                                class="form-control div-spacing custom-input" id="curp" placeholder="CURP">
                            <div class="line"></div>
                        </div>
                        <div class="col-4">
                            <label for="campo" class="form-label input-text-form">N&uacutemero de empleado</label><label class="text-required"></label>
                    ...
                    <div class="row mx-1">
                        ...
                        <div class="row mx-1">
                            <div class="col-3">
                                <label for="campo" class="form-label input-text-form">País de nacimiento</label><label class="text-required">*</label>
                            ...
                            <div class="col-3">
                                <label for="campo" class="form-label input-text-form">Nacionalidad</label><label class="text-required">*</label>
                                <select class="form-control custom-select selectpicker"
                                    data-style="input-select-selectpicker" aria-label="Default select example"
                            ...
                            <div class="col-3">
                                <label for="campo" class="form-label input-text-form">Estado civil</label><label class="text-required">*</label>
                                <select class="form-control custom-select selectpicker"
                                    data-style="input-select-selectpicker" aria-label="Default select example"
                        ...
                        <div class="row mx-1">
                            <div class="col-3">
                                <fieldset disabled>
                                    <label for="campo" class="form-label input-text-form">Género</label>
                                    <input type="text" placeholder="Género" class="form-control custom-input" id="genero_x">
                                    <div class="line"></div>
                                </fieldset>
                            </div>
                            <div class="col-3">
                                <label for="campo" class="form-label input-text-form">NSS</label><label class="text-required">*</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success save-botton-modal" onclick="return validar();"><i class="fas fa-save"></i> Guardar</button>
